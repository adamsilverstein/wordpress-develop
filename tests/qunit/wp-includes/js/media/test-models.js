...
( function() {
	 ...
	 */
	QUnit.test( 'observing a selection does not corrupt totalAttachments (Trac #65053)', function( assert ) {
	...
	QUnit.test( 'mirrored query add/remove still drives totalAttachments', function( assert ) {
		var Attachments = wp.media.model.Attachments,
			Attachment = wp.media.model.Attachment,
			query,
			library,
